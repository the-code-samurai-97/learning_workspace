...
def open3d_macos():
    http_archive(
        name = "open3d_macos",
        sha256 = "3f6455881a38b170c7bba0622019137aaf359dcee374626ed000d4e7f8dfdd49",
        urls = ["https://github.com/isl-org/Open3D/releases/download/v0.17.0/open3d-devel-darwin-x86_64-0.17.0.tar.xz"],
        build_file = "//third_party/open3d_macos:open3d.BUILD.bzl",
        strip_prefix = "open3d-devel-darwin-x86_64-0.17.0",
    )
